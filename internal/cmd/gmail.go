...
type GmailCmd struct {
	...
	Attachment GmailAttachmentCmd `cmd:"" name:"attachment" group:"Read" help:"Download a single attachment (use --out - to stream to stdout: base64 in --json mode, raw bytes otherwise)"`
